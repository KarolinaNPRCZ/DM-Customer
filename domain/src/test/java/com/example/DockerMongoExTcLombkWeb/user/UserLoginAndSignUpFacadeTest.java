...
class UserLoginAndSignUpFacadeTest {
    ...
    void should_successfully_createUser() {
        ...
        //WHEN
        Integer userIdCreatedUser = userLoginAndSignUpFacade.createUser(userEmail, userPassword);
    ...
    void should_successfully_getUserDTOByUserEmail_find_user() {
        //GIVEN
        UserDTO userDTO = UserDTO.builder().userId(5).email("existing@user.com").password("userPassword").build();
